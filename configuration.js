...
let onAnyExit = (passage) => console.log(`Exiting ${getPassageTitle(passage)}`);
// runs on the links rendering for any passage
let onAnyLinkRender = (passage) => console.log(`Links rendering for ${getPassageTitle(passage)}`);
